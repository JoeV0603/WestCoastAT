...
public class Cart {
    ...
    public void the_user_is_on_the_cart_page() throws InterruptedException {
		...
		WebElement cartIcon = driver.findElement(By.xpath("//span[@class='xoo-wsc-sc-bki xoo-wsc-icon-basket1']"));
    ...
    public void the_cart_should_display_the_correct_items() throws InterruptedException {
    	...
    	try {
            ...
            List<String> expectedNames = Arrays.asList("Decaf Colombian Whole Bean Coffee: 5 lb.", "Colombian Supremo Whole Bean Coffee: 5 lb.");
            List<Integer> expectedQuantities = Arrays.asList(1, 1);
            List<String> expectedPrices = Arrays.asList("$ 39.99", "$ 39.99");
    ...
    public void the_user_is_on_a_product_detail_page() throws InterruptedException {
		...
		driver.findElement(By.xpath("//a[@href='https://westcoast.wp.shottqsr.com/product/product-decaf-colombian-whole-bean-coffee-5lb/']")).click();;
    ...
    public void the_user_adds_the_product_to_the_cart() throws InterruptedException {
		...
		wait1.until(ExpectedConditions.elementToBeClickable(cartLink));
    ...
    public void the_cart_should_contain_the_added_product_from_detail_page() throws InterruptedException {
    	...
    	try {
            ...
            String expectedName = "Decaf Colombian Whole Bean Coffee: 5 lb.";
            int expectedQuantity = 1;
            String expectedPrice = "$ 39.99";
    ...
    public void the_user_adds_a_product_to_the_cart_from_listing_page() throws InterruptedException {
    	...
    	driver.findElement(By.xpath("//a[@href='?add-to-cart=1794']")).click();;
    ...
    public void the_user_logs_out_and_logs_back_in() throws InterruptedException {
        ...
        WebElement logoutLink = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(@href, 'customer-logout')]")));
        logoutLink.click();
   ...
   //     assertTrue(couponCode.isDisplayed());
    ...
    public void the_user_adds_multiple_products_to_the_cart() throws InterruptedException {
        ...
        WebElement closeCart = driver.findElement(By.xpath("//span[@class='xoo-wsch-close xoo-wsc-icon-cross']"));
        ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", closeCart);
		WebDriverWait wait1 = new WebDriverWait(driver, Duration.ofSeconds(20));
		wait1.until(ExpectedConditions.elementToBeClickable(closeCart));
		Actions actions1 = new Actions(driver);
		actions1.moveToElement(closeCart).click().perform();
        
		Thread.sleep(2000);
		
        driver.findElement(By.id("product-search")).sendKeys("French");
    	
		Thread.sleep(5000);
        
		WebElement addToCartButton = driver.findElement(By.xpath("//a[@href='?add-to-cart=1797']"));
    ...
    public void the_cart_should_contain_all_the_added_products() throws InterruptedException {
    	...
    	try {
            ...
            List<String> expectedNames = Arrays.asList("Decaf Colombian Whole Bean Coffee: 5 lb.", "French Vanilla Whole Bean Coffee: 5 lb.");
            List<Integer> expectedQuantities = Arrays.asList(1, 1);
            List<String> expectedPrices = Arrays.asList("$ 39.99", "$ 39.99");
