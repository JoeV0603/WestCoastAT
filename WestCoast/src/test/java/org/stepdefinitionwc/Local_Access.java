...
public class Local_Access {
    ...
    public void the_user_resizes_the_text() throws InterruptedException {
        
    	WebElement textElement = driver.findElement(By.xpath("//a[@href='/shop']"));
    ...
    public void the_user_submits_the_form_with_invalid_data() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//input[@name='name-2']")).sendKeys("!@#$%^&");
    ...
    public void the_user_should_see_a_skip_navigation_link() throws InterruptedException {
    	...
    	try {
    		...
    		WebElement skipLink = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='skiptranslate']")));
    ...
    public void the_website_content_should_be_displayed_in_Spanish() throws InterruptedException {
        ...
        WebElement myaccount = driver.findElement(By.xpath("(//a[@class='main-login'])"));
        
        Thread.sleep(2000);
        
    	assertTrue(myaccount.isDisplayed());
        
    	assertEquals("Iniciar Sesión / Registrarse", myaccount.getText());
