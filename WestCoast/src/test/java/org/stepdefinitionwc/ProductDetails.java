...
public class ProductDetails {
    ...
    public void the_user_is_on_the_product_details_page() throws InterruptedException {
		...
		WebElement element = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[@href='https://westcoast.wp.shottqsr.com/product/product-colombian-supremo-whole-bean-5lb/']")));
		element.click();
    ...
    public void the_product_description_should_be_accurate() throws InterruptedException {
        ...
        String expectedText = "Roasted using only 100% Arabica specialty coffee beans from Colombia.";
    ...
    public void the_product_SKU_should_be_displayed() throws InterruptedException {
        ...
        String expectedText = "SKU: 5812064";
