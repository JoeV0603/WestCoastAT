...
public class AcctMgmnt {
    ...
    public void the_user_updates_their_profile_information() throws InterruptedException {
    	...
    	driver.findElement(By.xpath("//a[@href='https://boyds.wp.shottqsr.com/my-account/edit-account/']")).click();
    ...
    public void the_user_saves_a_new_payment_method() throws InterruptedException {
    	...
    	driver.findElement(By.xpath("//a[@href='https://boyds.wp.shottqsr.com/my-account/payment-methods/']")).click();
      ...
      try {
	    ...
	    WebElement element = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[@value='Add payment method']")));
	    element.click();
    ...
    public void the_user_should_be_logged_out_successfully() throws InterruptedException {
        ...
        String expectedText = "Login Or Register";
